...
for key in OPENCLAW_IMAGE OPENCLAW_QQBOT_PLUGIN OPENCLAW_GATEWAY_PORT OPENCLAW_GATEWAY_TOKEN OPENCLAW_TZ QQBOT_APP_ID QQBOT_CLIENT_SECRET CODEX_PROXY_BASE_URL CODEX_PROXY_TOKEN; do
